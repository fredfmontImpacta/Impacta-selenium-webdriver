...
//                    ChromeDriverManager.getInstance().setup();
    ...
    public void  ChooseOkOnNextConfirmation() throws Throwable{
        Alert alert = driver.switchTo().alert();
        TimeUnit.SECONDS.sleep(5); // para dar tempo da tela carregar
        alert.accept();
    }

    public void  ChooseCancelOnNextConfirmation() throws Throwable{
        Alert alert = driver.switchTo().alert();
        TimeUnit.SECONDS.sleep(5); // para dar tempo da tela carregar
        alert.dismiss();
    }
